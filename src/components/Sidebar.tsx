...
const Sidebar = () => {
  ...
  return (
    <div className="w-64 h-screen bg-sidebar flex flex-col border-r border-white/10">
      <div className="p-4 border-b border-white/10">
        <h1 className="text-xl font-bold text-gradient-primary mb-2">whereMYAPIKEY?</h1>
      ...
      <div className="flex items-center justify-between p-4 border-b border-white/10">
        <h2 className="text-sm font-semibold text-white/70">CATEGORIES</h2>
        <Button 
          variant="ghost" 
          size="icon" 
          onClick={() => {
